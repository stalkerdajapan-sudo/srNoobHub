--[[
    NOOB HUB v4.0 - Sistema de invisibilidade premium
    Drag em toda a GUI | Cor amarela | Design unificado
]]
...
local function alternarVisibilidade()
    ...
    local btn = janela:FindFirstChild("BtnAtivar")
    if btn then
...
local function alternarMinimizar()
    ...
    if minimizado then
        ...
        janela.Size = UDim2.new(0, 55, 0, 55)
...
local function criarInterface()
    ...
    btnMinimizar.Position = UDim2.new(0.8, 0, 0.12, 0)
    btnMinimizar.Text = "─"
    ...
    btnFechar.Position = UDim2.new(0.9, 0, 0.12, 0)
    btnFechar.Text = "✕"
    ...
    info.Text = "⌨ Tecla 'G' para alternar"
    ...
    btnAtivar.Size = UDim2.new(0.9, 0, 0, 45)
    btnAtivar.Position = UDim2.new(0.05, 0, 0.58, 0)
    btnAtivar.Text = "🔴 DESATIVADO"
    btnAtivar.TextColor3 = Color3.fromRGB(255, 255, 255)
    btnAtivar.TextSize = 17
...
print("⭐ NOOB HUB v4.0 CARREGADO!")
print("⭐ Drag em TODA a GUI!")
print("⭐ Cor amarela premium!")
print("⭐ Clique em '─' para minimizar")
print("⭐ Clique em '✕' 2x para fechar")
print("⭐ Tecla 'G' para ativar/desativar")
